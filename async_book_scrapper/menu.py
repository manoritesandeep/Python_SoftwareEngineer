...
- 'b' to look at 5-star pages
- 'c' to look at the cheapest pages
...
def print_best_books():
    logger.debug('Finding best pages by rating...')
...
def print_cheapest_books():
    logger.debug('Finding best pages by price...')
...
def get_next_book():
    logger.debug('Getting next book from generator of all pages...')
